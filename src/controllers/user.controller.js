...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    await User.findByIdAndUpdate(
        ...
        {
            $set: {
                avatr: avatar.url // sirf ek field update krne k liye set use hota $=> ye bhot saare operator 
            }
        },
        {new: true}
    ).select("-password");
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    await User.findByIdAndUpdate(
        ...
        {
            $set: {
                coverImage: coverImage.url // sirf ek field update krne k liye set use hota $=> ye bhot saare operator 
            }
        },
        {new: true}
    ).select("-password");
